...
class TestPayment:
    ...
    def test_successful_payment(self, driver, db, clear_db):
    ...
    def test_owner_min_length(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с владельцем из 1 символа не прошла"

    @allure.title("POS-04: Владелец - максимальная длина (64 символа)")
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_max_length(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с владельцем из 64 символов не прошла"

    @allure.title("POS-05: Владелец - двойная фамилия через дефис")
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_double_surname(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с двойной фамилией не прошла"

    @allure.title("POS-06: Месяц - минимальное значение (01)")
    @allure.severity(allure.severity_level.NORMAL)
    def test_month_min_value(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с месяцем 01 не прошла"

    @allure.title("POS-07: Месяц - максимальное значение (12)")
    @allure.severity(allure.severity_level.NORMAL)
    def test_month_max_value(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с месяцем 12 не прошла"

    @allure.title("POS-08: Год - текущий")
    @allure.severity(allure.severity_level.NORMAL)
    def test_year_current(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с текущим годом не прошла"

    @allure.title("POS-09: Год - +5 лет от текущего")
    @allure.severity(allure.severity_level.NORMAL)
    def test_year_plus_five(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с годом +5 лет не прошла"

    @allure.title("POS-10: CVC - ведущие нули (001)")
    @allure.severity(allure.severity_level.NORMAL)
    def test_cvc_leading_zeros(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с CVC 001 не прошла"

    @allure.title("POS-11: CVC - максимальное значение (999)")
    @allure.severity(allure.severity_level.NORMAL)
    def test_cvc_max_value(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
        ...
        page.submit_form()
        assert page.is_success_visible(), "Оплата с CVC 999 не прошла"

    # ==================== НЕГАТИВНЫЕ СЦЕНАРИИ ====================

    @allure.title("NEG-01: Оплата отклоняемой картой")
    @allure.severity(allure.severity_level.CRITICAL)
    def test_declined_payment(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_card_number_all_zeros(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            "0000 0000 0000 0000",
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_card_number_15_digits(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            "4444 4444 4444 444",
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_card_number_17_digits(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_card_number_with_letters(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            "4444 4444 4444 ABCD",
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_month_zero(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_month_thirteen(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_month_empty(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_year_past(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_year_zero(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_year_empty(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_cyrillic(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_digits(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_special_chars(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_only_space(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_owner_empty(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_cvc_one_digit(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_cvc_two_digits(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_cvc_zeros(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_cvc_empty(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_expired_card_past_year_current_month(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_expired_card_current_year_past_month(self, driver, db, clear_db):
        page = PaymentPage(driver)
        page.select_payment_tab()
        page.fill_card_data(
            Data.get_valid_card(),
